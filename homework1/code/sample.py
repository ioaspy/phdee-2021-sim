...
outputpath = r'C:\Users\ioasp\Desktop\Ioanna\Economics\gatech courses\Spring 2021\Environment II\GitHub\phdee-2021-IS\homework1\output'
...
sns.distplot(yvar,hist =False,label = 'Distribution of outcome variable')
plt.xlabel('Outcome variable')
plt.savefig('samplehist.eps',format='eps') # I suggest saving to .eps for highest quality
plt.show()
